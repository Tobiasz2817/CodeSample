...
namespace CoreUtility.Extensions {
    public static class GameObjectExtensions {
        ...
        public static void ResetLocalTransformation(this GameObject gameObject) {
        ...
        public static GameObject FindTargetOnSameLayerWithTag(this GameObject target, string tag) {
            var selfParent = target.transform.parent;
            for (var i = 0; i < selfParent.childCount; i++) {
                var child = selfParent.GetChild(i);
        ...
        public static T GetComponent<T>(this GameObject target, ReadType readingType) {
        ...
        public static void DestroySelf(this GameObject prefab) => Object.Destroy(prefab);
    }
}
